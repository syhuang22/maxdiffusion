...
To generate images, run the following command:
  ...
  * For Wan2.2 I2V, use `base_wan_i2v_27b.yml`.
  ...
  > **Note:** Speedup numbers are measured on TPU v6e-8 with 720p 81-frame generation at 50 inference steps. Actual speedup may vary depending on hardware, resolution, and model size.
